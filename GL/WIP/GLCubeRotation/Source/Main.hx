...
//    private var glUniformMatrix4fv:Float32Array;
...
/* ====== Associating attributes to vertex shader =====*/
         ...
         var proj_matrix = get_projection(40, Std.int(window.width/window.height), 1, 1000);
...
//            gl.viewport(Std.int(0), Std.int(0), Std.int(window.width), Std.int(window.height));
